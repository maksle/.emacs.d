(setq ss-program "/cygdrive/c/Program Files\ (x86)/Microsoft\ Visual\ SourceSafe/ss.exe"
      ss-project-dirs '(("^/cygdrive/c/usr/netscape/docs/" . "$/xls/docs/")
                        ("^/cygdrive/c/Users/xls/" . "$/xls/")
                        ("^/cygdrive/c/Users/xls.net/" . "$/xls.net/")))
