...
This is achieved by using `sql-forward-sexp'.  The list ends when a word
...
balance.  This is achieved by using `sql-forward-sexp'.  The assignment ends
